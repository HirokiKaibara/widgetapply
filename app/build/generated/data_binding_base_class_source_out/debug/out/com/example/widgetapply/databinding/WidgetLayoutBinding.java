...
public final class WidgetLayoutBinding implements ViewBinding {
  ...
  private WidgetLayoutBinding(@NonNull RelativeLayout rootView, @NonNull TextView widgetText) {
  ...
  public static WidgetLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WidgetLayoutBinding((RelativeLayout) rootView, widgetText);
    }
